...
# 输出目录：相对于脚本所在目录的 ../Test/extract_test_subset_test/
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_DIR = os.path.join(SCRIPT_DIR, '..', 'Test', 'extract_test_subset_test')
...
def pick_active_users(cursor, target_count=1000):
    ...
    query = """
        ...
        LIMIT %s
    """
    cursor.execute(query, (target_count * 3,))  # 多取一些做随机挑选
